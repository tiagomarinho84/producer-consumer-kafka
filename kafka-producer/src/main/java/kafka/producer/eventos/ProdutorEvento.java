package kafka.producer.eventos;
...
public class ProdutorEvento {
    ...
    public void executar() {
        ...
        log.info("Iniando envio da mensagem");

        ProducerRecord<String, String> recorder = new ProducerRecord<>("RegistroEvento", chave, mensagem);
